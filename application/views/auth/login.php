    ...
    <div class="register-form">
        <div class="form-content">
            <div class="form-content--table-cell">
                <a class="logo  mgb-20" href="<?php echo base_url($this->lang->lang().'/Principal'); ?>"><img height="47px;" src= "<?php echo base_url('assets/img/logos/logo.jpg'); ?>" alt="Aigües de Barcelona" title="Aigües de Barcelona"/></a>
